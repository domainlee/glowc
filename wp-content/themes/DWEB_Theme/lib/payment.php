...
add_action( 'wp_ajax_nopriv_created_payment', 'created_payment' );
add_action( 'wp_ajax_created_payment', 'created_payment' );
...
//    require_once( __DIR__ . '/lib/payment/config.php');
    ...
    $vnp_Returnurl = "http://theme.com/calista/checkout";
